...
export const Navbar: React.FC = () => {
  ...
  const allPageLinks: { id: PageId; label: string; group: string; icon: any }[] = [
    ...
    { id: 'about', label: '3. About Academy', group: 'Core', icon: Heart },
    { id: 'courses', label: '4. All Courses', group: 'Academic', icon: GraduationCap },
    { id: 'teachers', label: '4. Qualified Teachers', group: 'Academic', icon: Award },
    { id: 'zaitoon-traders', label: '5. ZT (Zaitoon Traders)', group: 'Ecosystem', icon: ShoppingBag },
    { id: 'marriage-bureau', label: '6. Shaheen Marriage Bureau', group: 'Ecosystem', icon: Heart },
    { id: 'growth-hub', label: '7. Growth & Earning Hub', group: 'Monetization', icon: TrendingUp },
    { id: 'ad-manager', label: '8. AI Ad Studio & Social Hub', group: 'Monetization', icon: Megaphone },
    { id: 'student-portal', label: '8. Student Portal', group: 'Portals', icon: UserCheck },
    { id: 'parent-portal', label: '9. Parent Portal', group: 'Portals', icon: Shield },
    { id: 'admissions', label: '10. Online Admissions', group: 'Academic', icon: FileText },
    { id: 'fee-payment', label: '11. Fee & EasyPaisa', group: 'Finance', icon: CreditCard },
    { id: 'live-classes', label: '12. Live Classes Studio', group: 'Academic', icon: Calendar },
    { id: 'certificates', label: '13. Certificates Verification', group: 'Academic', icon: Award },
    { id: 'gallery', label: '14. Photo & Video Gallery', group: 'Media', icon: ImageIcon },
    { id: 'blog', label: '15. Islamic Articles & Blog', group: 'Media', icon: FileText },
    { id: 'testimonials', label: '16. Student Testimonials', group: 'Social', icon: Sparkles },
    { id: 'faq', label: '17. Frequently Asked Questions', group: 'Support', icon: HelpCircle },
    { id: 'contact', label: '18. Contact Us (Rawalpindi HQ)', group: 'Support', icon: MapPin },
    { id: 'careers', label: '19. Teacher Careers Application', group: 'Support', icon: Briefcase },
    { id: 'privacy', label: '20. Privacy Policy', group: 'Legal', icon: Shield },
    { id: 'terms', label: '21. Terms & Conditions', group: 'Legal', icon: FileText },
    { id: 'donations', label: '22. Sadaqah Jariyah & Donations', group: 'Finance', icon: Heart },
    { id: 'help-support', label: '23. Help Desk & Support Desk', group: 'Support', icon: MessageSquare },
